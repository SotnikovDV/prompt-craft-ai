...
<div class="min-h-screen bg-gray-50 py-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8 flex items-center justify-between">
            ...
            <a href="{{ route('admin.settings') }}" class="flex items-center text-blue-600 hover:text-blue-800 font-medium mr-2">
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">LLM</th>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach($requests as $request)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                        @if($request->gen_provider && $request->gen_model)
                                            <div>
                                                <div class="font-medium">{{ ucfirst($request->gen_provider) }}</div>
                                                <div class="text-xs text-gray-500">{{ Str::limit($request->gen_model, 30) }}</div>
                                            </div>
                                        @else
                                            <span class="text-gray-500">—</span>
                                        @endif
